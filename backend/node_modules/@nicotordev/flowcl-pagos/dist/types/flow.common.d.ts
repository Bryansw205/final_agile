 ...
 */
type FlowPaymentMethods = 'webpay-plus' | 'mach' | 'khipu' | 'redpay' | 'onepay' | 'flow';
/**
...
export type { FlowPaymentMethods, FlowPaymentStatus, FlowConstants, FlowSearchRequest, FlowPaginatedData, };
